...
int rod_cutting(int price[],int n,int N,int len[],vector<vector<int>>dp)
{
    ...
    // }
     ...
     //simply replace these above commented lines of memorization concept with top down dp with simply replacing the recurive class from 
     //memorization just storing every result into dp[][] matrix
    ...
    //Printing Matrix to see how values go inside
    // for(int i=0;i<n+1;i++)
    // {
    //     for(int j=0;j<N+1;j++)
    //     {
