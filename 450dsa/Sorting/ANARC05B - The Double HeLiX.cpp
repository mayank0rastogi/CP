...
int main()
{
    ...
    while(true)
    {
        ...
        else
        {
            ...
            //take two temporary sum pointer and two pointer
            int s1=0,s2=0;
            int i=0,j=0;
            int wholesum=0;
            while(i<n and j<m)
            {
                ...
                {
                    wholesum=wholesum + max(s1,s2) + a[i];
                    s1=s2=0;
                    i++;
                    j++;
                }
            }
            //for remaining elements when no bridge is there remaining
            while(i<n)
            {
                s1+=a[i++];
            }
